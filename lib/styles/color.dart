...
class AppColors{
  static const Color colorPrimary = Color(0xFF365EFF);
  static const Color colorPrimaryDark = Color(0xFF1c3aa9);
  static const Color colorPrimaryLight =  Color(0xFF6281fc);
  ...
  static const Color colorTabBackground = Color(0xFFEDF0FF);
}