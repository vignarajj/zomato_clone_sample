...
class DetailsPage extends StatefulWidget {
  ...
  DetailsPage({this.nearbyRestaurant, this.status});
...
class _DetailsPageState extends State<DetailsPage> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<ConnectivityResult>.value(
      value: _status.networkStatusController.stream,
      child: Consumer<ConnectivityResult>(builder: (context, value, _) {
        bool _isConnected = value == ConnectivityResult.none ? false : true;
        return SafeArea(
          child: Scaffold(
                      ...
                      children: [
                        Container(
                          ...
                          child: Align(
                            ...
                            child: TextBold(
                              text: "${_restaurant.restaurant.name}",
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextMedium(
                                  text:
                                      "${_restaurant.restaurant.userRating.ratingText}",
                        ...
                        Container(
                          ...
                          child: Align(
                            ...
                            child: TextRegular(
                              text:
                                  "${_restaurant.restaurant.location.address}",
                              textColor: AppColors.black,
                              textSize: SizeConfig.medium,
                            ),
                          ),
